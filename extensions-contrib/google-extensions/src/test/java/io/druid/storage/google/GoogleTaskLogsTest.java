...
public class GoogleTaskLogsTest extends EasyMockSupport {
  ...
  public void testPushTaskLog() throws Exception {
    ...
    try {
      ...
      storage.insert(EasyMock.anyString(), EasyMock.anyString(), EasyMock.<InputStreamContent> anyObject());
      //storage.insert(bucket, prefix + "/" + taskid, EasyMock.<InputStreamContent> anyObject());
      expectLastCall();
