...
public class SelectorFilterTest extends BaseFilterTest
{
  ...
  {
    assertFilterMatches(new SelectorDimFilter("dim0", null, null, null), ImmutableList.<String>of());
    assertFilterMatches(new SelectorDimFilter("dim0", "", null, null), ImmutableList.<String>of());
    assertFilterMatches(new SelectorDimFilter("dim0", "0", null, null), ImmutableList.of("0"));
    assertFilterMatches(new SelectorDimFilter("dim0", "1", null, null), ImmutableList.of("1"));
  }

  @Test
  public void testSingleValueStringColumnWithNulls()
  {
    assertFilterMatches(new SelectorDimFilter("dim1", null, null, null), ImmutableList.of("0"));
    assertFilterMatches(new SelectorDimFilter("dim1", "", null, null), ImmutableList.of("0"));
    assertFilterMatches(new SelectorDimFilter("dim1", "10", null, null), ImmutableList.of("1"));
    assertFilterMatches(new SelectorDimFilter("dim1", "2", null, null), ImmutableList.of("2"));
    assertFilterMatches(new SelectorDimFilter("dim1", "1", null, null), ImmutableList.of("3"));
    assertFilterMatches(new SelectorDimFilter("dim1", "def", null, null), ImmutableList.of("4"));
    assertFilterMatches(new SelectorDimFilter("dim1", "abc", null, null), ImmutableList.of("5"));
    assertFilterMatches(new SelectorDimFilter("dim1", "ab", null, null), ImmutableList.<String>of());
  }

  @Test
  public void testMultiValueStringColumn()
  {
    assertFilterMatches(new SelectorDimFilter("dim2", null, null, null), ImmutableList.of("1", "2", "5"));
    assertFilterMatches(new SelectorDimFilter("dim2", "", null, null), ImmutableList.of("1", "2", "5"));
    assertFilterMatches(new SelectorDimFilter("dim2", "a", null, null), ImmutableList.of("0", "3"));
    assertFilterMatches(new SelectorDimFilter("dim2", "b", null, null), ImmutableList.of("0"));
    assertFilterMatches(new SelectorDimFilter("dim2", "c", null, null), ImmutableList.of("4"));
    assertFilterMatches(new SelectorDimFilter("dim2", "d", null, null), ImmutableList.<String>of());
  }

  @Test
  public void testMissingColumnSpecifiedInDimensionList()
  {
    assertFilterMatches(new SelectorDimFilter("dim3", null, null, null), ImmutableList.of("0", "1", "2", "3", "4", "5"));
    assertFilterMatches(new SelectorDimFilter("dim3", "", null, null), ImmutableList.of("0", "1", "2", "3", "4", "5"));
    assertFilterMatches(new SelectorDimFilter("dim3", "a", null, null), ImmutableList.<String>of());
    assertFilterMatches(new SelectorDimFilter("dim3", "b", null, null), ImmutableList.<String>of());
    assertFilterMatches(new SelectorDimFilter("dim3", "c", null, null), ImmutableList.<String>of());
  }

  @Test
  public void testMissingColumnNotSpecifiedInDimensionList()
  {
    assertFilterMatches(new SelectorDimFilter("dim4", null, null, null), ImmutableList.of("0", "1", "2", "3", "4", "5"));
    assertFilterMatches(new SelectorDimFilter("dim4", "", null, null), ImmutableList.of("0", "1", "2", "3", "4", "5"));
    assertFilterMatches(new SelectorDimFilter("dim4", "a", null, null), ImmutableList.<String>of());
    assertFilterMatches(new SelectorDimFilter("dim4", "b", null, null), ImmutableList.<String>of());
    assertFilterMatches(new SelectorDimFilter("dim4", "c", null, null), ImmutableList.<String>of());
  }
  ...
  public void testSelectorWithLookupExtractionFn()
  {
    ...
    assertFilterMatches(new SelectorDimFilter("dim0", "HELLO", lookupFn, null), ImmutableList.of("1"));
    assertFilterMatches(new SelectorDimFilter("dim0", "UNKNOWN", lookupFn, null), ImmutableList.of("0", "2", "3", "4", "5"));

    assertFilterMatches(new SelectorDimFilter("dim1", "HELLO", lookupFn, null), ImmutableList.of("3", "4"));
    assertFilterMatches(new SelectorDimFilter("dim1", "UNKNOWN", lookupFn, null), ImmutableList.of("0", "1", "2", "5"));

    assertFilterMatches(new SelectorDimFilter("dim2", "HELLO", lookupFn, null), ImmutableList.of("0", "3"));
    assertFilterMatches(new SelectorDimFilter("dim2", "UNKNOWN", lookupFn, null), ImmutableList.of("0", "1", "2", "4", "5"));

    assertFilterMatches(new SelectorDimFilter("dim3", "HELLO", lookupFn, null), ImmutableList.<String>of());
    assertFilterMatches(new SelectorDimFilter("dim3", "UNKNOWN", lookupFn, null), ImmutableList.of("0", "1", "2", "3", "4", "5"));

    assertFilterMatches(new SelectorDimFilter("dim4", "HELLO", lookupFn, null), ImmutableList.<String>of());
    assertFilterMatches(new SelectorDimFilter("dim4", "UNKNOWN", lookupFn, null), ImmutableList.of("0", "1", "2", "3", "4", "5"));
    ...
    assertFilterMatches(new SelectorDimFilter("dim0", "5", lookupFn2, null), ImmutableList.of("2", "5"));
    ...
    assertFilterMatches(new SelectorDimFilter("dim0", null, lookupFn3, null), ImmutableList.of("0", "1", "2", "3", "4", "5"));
    ...
    SelectorDimFilter optFilter1 = new SelectorDimFilter("dim1", "UNKNOWN", lookupFn, null);
    SelectorDimFilter optFilter2 = new SelectorDimFilter("dim0", "5", lookupFn2, null);
    SelectorDimFilter optFilter3 = new SelectorDimFilter("dim0", null, lookupFn3, null);
    SelectorDimFilter optFilter4 = new SelectorDimFilter("dim0", "5", lookupFn4, null);
    SelectorDimFilter optFilter5 = new SelectorDimFilter("dim0", "5", lookupFn5, null);
    SelectorDimFilter optFilter6 = new SelectorDimFilter("dim0", "5", lookupFn6, null);

    InDimFilter optFilter2Optimized = new InDimFilter("dim0", Arrays.asList("2", "5"), null);
    SelectorDimFilter optFilter4Optimized = new SelectorDimFilter("dim0", "5", null, null);
    SelectorDimFilter optFilter6Optimized = new SelectorDimFilter("dim0", "5", null, null);
