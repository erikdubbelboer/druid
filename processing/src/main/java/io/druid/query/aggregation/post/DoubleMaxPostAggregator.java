...
public class DoubleMaxPostAggregator implements PostAggregator
{
  ...
  @JsonCreator
  public DoubleMaxPostAggregator(
  ...
  {
    return "DoubleMaxPostAggregator{" +
           "name='" + name + '\'' +
           ", fields=" + fields +
           "}";
  }
  ...
  public boolean equals(Object o)
  {
    ...
    DoubleMaxPostAggregator that = (DoubleMaxPostAggregator) o;
